...
<ul>
	...
	<li>pour le tableau final : le <strong><?php echo strftime('%A %d %B &agrave; %H:%M',$timestamp_tableau_debut);?></strong> (attention vous n'aurez qu'une seule journée pour parier)</li>
</ul>
...
$r_matchs_speciaux=mysql_query($s_matchs_speciaux);
...
<table class="table_reglement">
	...
	<tr>
		<td><img src="public/images/flags/GRE.gif" alt="flag" /> Grèce</td><td class="score">2</td><td class="score">2</td>
	</tr>
	<tr>
		<td><img src="public/images/flags/RUS.gif" alt="flag" /> Russie</td><td class="score">2</td><td class="score">1</td>
	</tr>
</table>
...
<h2>Phase Finale</h2>
Pour la phase finale, le meme type de barème s'applique. Les coefficients multiplicateurs seront de 3, 4 et 6 pour 1/4,
1/2 et finales.<br/>
...
malus de +3 par participant non pronostiqué.<br/><br/>
...
<table class="table_reglement">
	...
	<tr>
		<td><img src="public/images/flags/POR.gif" alt="flag" /> PORTUGAL</td><td class="score">1</td><td>TAB : 3</td>
	</tr>
	<tr>
		<td><img src="public/images/flags/ITA.gif" alt="flag" />  ITALIE</td><td class="score">1</td><td>TAB : 4</td>
	</tr>
</table>
...
<table class="table_reglement">
	...
	<tr>
		<td><img src="public/images/flags/FRA.gif" alt="flag" /> FRANCE</td><td class="score">0</td>
	</tr>
	<tr>
		<td><img src="public/images/flags/ITA.gif" alt="flag" /> ITALIE</td><td class="score">1</td>
	</tr>
</table>
...
<div class="table_reglement">
4 &bull; ( 3 + (-5 * 0) + |1-0| + |1-1|) = 4*(6) = 16 points.
</div>
<p>
...
LE JOUEUR AYANT PRONOSTIQUE LE BON VAINQUEUR DE L'EURO SE VOIT
ATTRIBUER UN BONUS DE -30 PTS, CE QUI PROMET UNE FINALE ANIMEE.</strong>
</p>

<h2>Pot de remise des récompenses</h2>
La date du pot sera définie par vote des joueurs.
